...
cp third_party/LLM-Fingerprint-and-Attacks/TFA_SVA/Fingerprint_dataset/ds_config.json .runtime/cau_trainer/ds_config.json
deepspeed --num_gpus=1 .runtime/cau_trainer/train_fingerprint.py --deepspeed .runtime/cau_trainer/ds_config.json --model_name_or_path "$BASE_MODEL" --data_path data/imf/train_stego60.json --output_dir checkpoints/source --num_train_epochs 20 --per_device_train_batch_size 1 --per_device_eval_batch_size 1 --gradient_accumulation_steps 16 --evaluation_strategy no --save_strategy epoch --save_total_limit 1 --learning_rate 2e-5 --weight_decay 0 --warmup_ratio 0.03 --lr_scheduler_type cosine --logging_steps 1 --report_to none --gradient_checkpointing True --bf16 True --fp16 False --model_max_length 512
